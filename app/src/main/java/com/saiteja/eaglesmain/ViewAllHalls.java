...
public class ViewAllHalls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_halls);
    ...
    public void getDetails()
    {
        ...
        StringRequest strReq=new StringRequest(Request.Method.POST, AppConfig.getHalls , new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        details.add(result.getString("cid"));
                    }
                    showList();
    ...
    public void showList()
    {
        ...
        final ListView listView=(ListView)findViewById(R.id.hallsListView);
        listView.setAdapter(arrayAdapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ViewAllHalls.this, arrayAdapter.getItem(position), Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(ViewAllHalls.this,UpdateCRoom.class);
