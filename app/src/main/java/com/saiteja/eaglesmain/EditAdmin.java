...
public class EditAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ld = (EditText)findViewById(R.id.ld);
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if(!error) {
                        ...
                        str_ld = jObj.getString("ld");
                        String message = jObj.getString("message");
                        Toast.makeText(EditAdmin.this, "" + message, Toast.LENGTH_LONG).show();

                    }
                    else
                    {
                        String message=jObj.getString("message");
                        Toast.makeText(EditAdmin.this, message, Toast.LENGTH_SHORT).show();
                    }
    ...
    public void updateUser(View view) {
        ...
        StringRequest strReq=new StringRequest(Request.Method.POST, AppConfig.editUserDetails, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Intent i = new Intent(EditAdmin.this,AdminLogged.class);
                startActivity(i);
